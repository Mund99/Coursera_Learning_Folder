    ...
    # TASK 2.6: Create and display graphs for Yearly Report Statistics
        ...
        Y_chart1 = dcc.Graph(
            figure=px.line(
                ...
                x='Month',
                y='Automobile_Sales',
                title=f'Yearly Automobile Sales for the Year {selected_year}'
            )
        )
        ...
        Y_chart2 = dcc.Graph(
            figure=px.line(
                ...
                x='Month',
                y='Automobile_Sales',
                title=f'Total Monthly Automobile Sales for the Year {selected_year}'
            )
        )
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(
                ...
                names='Vehicle_Type',
                values='Advertising_Expenditure',
                title=f'Total Advertising Expenditure by Vehicle Type in the Year {selected_year}'
            )
        )
